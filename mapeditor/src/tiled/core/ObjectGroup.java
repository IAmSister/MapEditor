...
/**
 * @version $Id: ObjectGroup.java,v 1.1 2007/10/17 07:56:36 gulei Exp $
 */
public class ObjectGroup extends MapLayer
{
    private LinkedList<MapObject> boundObjects;

    public ObjectGroup() {
        boundObjects = new LinkedList<MapObject>();
    }
    /**
    ...
    public ListIterator<MapObject> getObjects() {
        return (ListIterator<MapObject>) boundObjects.iterator();
    }
}
