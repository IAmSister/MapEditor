 ...
 *
 * @version $Id: Tile.java,v 1.2 2007/11/13 06:41:54 chaiyp Exp $
 */
public class Tile
{
	public static final String TILE_PATH_NORMAL = "tile.path.normal";
	public static final String TILE_PATH_TRANSPARENT = "tile.path.transparent";
	public static final String TILE_AREA_NORMAL = "tile.area.normal";
