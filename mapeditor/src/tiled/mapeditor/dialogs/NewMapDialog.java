...
/**
 * @version $Id: NewMapDialog.java,v 1.2 2007/11/13 06:41:55 chaiyp Exp $
 */
public class NewMapDialog extends JDialog implements ActionListener
{
    ...
    private static final String DIALOG_TITLE = "创建新地图";//Resources.getString("dialog.newmap.title");
    private static final String MAPSIZE_TITLE = "地图尺寸(块为单位)";//Resources.getString("dialog.newmap.mapsize.title");
    private static final String TILESIZE_TITLE = "地图块尺寸";//Resources.getString("dialog.newmap.tilesize.title");
    private static final String WIDTH_LABEL = "宽度";//Resources.getString("dialog.newmap.width.label");
    private static final String HEIGHT_LABEL = "高度";//Resources.getString("dialog.newmap.height.label");
    private static final String MAPTYPE_LABEL = "地图类型";//Resources.getString("dialog.newmap.maptype.label");
    ...
    private static final String ISOMETRIC_MAPTYPE = "菱形斜45度";//Resources.getString("general.maptype.isometric");
    ...
    private static final String ORTHOGONAL_MAPTYPE = "矩形";//Resources.getString("general.maptype.orthogonal");
    private static final String STAGGERED_MAPTYPE = "矩形斜45度";
    ...
    private void init() {
        ...
        mapTypeChooser.addItem(STAGGERED_MAPTYPE);
    ...
    public Map create() {
    	// TODO::创建新的地图，把默认的层都添加上去，今后不再需要修改
        setVisible(true);
        return newMap;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equals(OK_BUTTON)) {
            ...
            } else if(mapTypeString.equals(STAGGERED_MAPTYPE)){
            	orientation = Map.MDO_STAGGERED;
            }
            ...
            System.out.println("layer num = " + newMap.getTotalLayers());
            // Save dialog options
