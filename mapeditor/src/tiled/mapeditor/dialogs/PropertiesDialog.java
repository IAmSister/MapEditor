...
/**
 * @version $Id: PropertiesDialog.java,v 1.1 2007/10/17 07:56:37 gulei Exp $
 */
public class PropertiesDialog extends JDialog
{
    ...
    private static final String DIALOG_TITLE = "属性";//Resources.getString("dialog.properties.title");
    private static final String OK_BUTTON = "确定";//Resources.getString("general.button.ok");
    private static final String DELETE_BUTTON = "删除";//Resources.getString("general.button.delete");
