       ...
       ListSelectionListener
{
    ...
    private static final String DIALOG_TITLE = "素材集管理器";//Resources.getString("dialog.tilesetmanager.title");
    private static final String CLOSE_BUTTON = "关闭";//Resources.getString("general.button.close");
    private static final String REMOVE_BUTTON = "移除";//Resources.getString("general.button.remove");
    private static final String EMBED_BUTTON = "嵌入";//Resources.getString("dialog.tilesetmanager.embed.button");
    private static final String SAVE_AS_BUTTON = "另存为";//Resources.getString("action.map.saveas.name");
    private static final String EDIT_BUTTON = "编辑";//Resources.getString("dialog.tilesetmanager.edit.button");
    private static final String SAVE_BUTTON = "保存";//Resources.getString("action.map.save.name");
        ...
        if (command.equals(CLOSE_BUTTON)) {
            ...
            if (checkSetUsage(set) > 0) {
                int ret = JOptionPane.showConfirmDialog(this,
                        "素材集正在被使用，确定要移除吗？",//Resources.getString("action.tileset.remove.in-use.message"),
                        "提示",//Resources.getString("action.tileset.remove.in-use.title"),
            ...
            try {
            	...
            	JOptionPane.showMessageDialog(this,
                        "包含该素材集的层正处于锁定状态,\n需要先解除锁定才能完全移除。",//Resources.getString("action.tileset.remove.error.layer-locked.message"),
                        "提示",//Resources.getString("action.tileset.remove.error.title"),
            ...
            if (ret == JFileChooser.APPROVE_OPTION) {
                ...
                if (exist.exists() && JOptionPane.showConfirmDialog(this,
                        "文件已经存在，要覆盖吗？")==//Resources.getString("general.file.exists.message")) ==
