    ...
    implements ActionListener, ListSelectionListener
{
    ...
    private static final String DIALOG_TITLE = "±à¼­ËØ²Ä¼¯";//Resources.getString("dialog.tile.title");
    private static final String OK_BUTTON = "È·¶¨";//Resources.getString("general.button.ok");
    private static final String DELETE_BUTTON = "É¾³ýËØ²Ä";//Resources.getString("dialog.tile.button.deletetile");
    private static final String CI_BUTTON = "»»Í¼";//Resources.getString("dialog.tile.button.changeimage");
    private static final String NEW_BUTTON = "Ìí¼ÓËØ²Ä";//Resources.getString("dialog.tile.button.newtile");
    private static final String CREATE_BUTTON = "´´½¨ËØ²Ä";//Resources.getString("dialog.tile.button.createtile");
    private static final String DUPLICATE_BUTTON = "¸´ÖÆËØ²Ä";//Resources.getString("dialog.tile.button.duptile");
    private static final String ANIMATION_BUTTON = "¶¯»­";//Resources.getString("dialog.tile.button.animation");
    private static final String PREVIEW_TAB = "Ô¤ÀÀ";//Resources.getString("general.button.preview");
    private static final String TILES_TAB = "ËØ²Ä";//Resources.getString("general.tile.tiles");
    private static final String IMAGES_TAB = "Í¼Ïñ";//"Images";
    private static final String NAME_LABEL = "ËØ²Ä¼¯Ãû³Æ";//Resources.getString("dialog.newtileset.name.label");
    private static final String ERROR_LOADING_IMAGE = "Í¼Æ¬¼ÓÔØ´íÎó";//Resources.getString("dialog.tile.image.load.error");
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (source == okButton) {
            ...
            int answer = JOptionPane.showConfirmDialog(
                    this,
                    "É¾³ýËØ²Ä?",//Resources.getString("action.tile.delete.confirm.message"),
                    "È·¶¨£¿",//Resources.getString("action.tile.delete.confirm.title"),
        ...
        */
            ...
            JOptionPane.showMessageDialog(
                    this,
                    MessageFormat.format("´´½¨id±àºÅÎª{0}µÄËØ²Ä",//Resources.getString("action.tile.create.done.message"),
                                         new Object[]{new Integer(n.getId())}),
                    "´´½¨ËØ²Ä",//Resources.getString("action.tile.create.done.title"),
