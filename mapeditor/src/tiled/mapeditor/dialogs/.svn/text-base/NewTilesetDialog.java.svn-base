...
public class NewTilesetDialog extends JDialog implements ChangeListener
{
    ...
    /* LANGUAGE PACK */
    private static final String DIALOG_TITLE = "创建素材集";//Resources.getString("dialog.newtileset.title");
    private static final String NAME_LABEL = "素材集名称";//Resources.getString("dialog.newtileset.name.label");
    private static final String TILE_WIDTH_LABEL = "素材宽度";//Resources.getString("dialog.newtileset.tilewidth.label");
    private static final String TILE_HEIGHT_LABEL = "素材高度";//Resources.getString("dialog.newtileset.tileheight.label");
    private static final String TILE_SPACING_LABEL = "素材间隔";//Resources.getString("dialog.newtileset.tilespacing.label");
    private static final String IMAGE_LABEL = "图才图片";//Resources.getString("dialog.newtileset.image.label");
    private static final String UNTITLED_FILE = "地图素材";//Resources.getString("general.file.untitled");
    private static final String TILESET_IMG_LABEL = "引用素材集图片";//Resources.getString("dialog.newtileset.tilesetimgref.label");
    private static final String USE_TRANS_COLOR_LABEL = "使用透明色";//Resources.getString("dialog.newtileset.usetransparentcolor.label");
    private static final String OK_BUTTON = "确定";//Resources.getString("general.button.ok");
    private static final String PREVIEW_BUTTON = "预览";//Resources.getString("general.button.preview");
    private static final String CANCEL_BUTTON = "取消";//Resources.getString("general.button.cancel");
    private static final String BROWSE_BUTTON = "浏览";//Resources.getString("general.button.browse");
    private static final String FROM_TILESET_IMG_TITLE = "来自素材集图片";//Resources.getString("dialog.newtileset.fromtilesetimg.title");
    private static final String IMPORT_ERROR_MSG = "导入素材集错误";//Resources.getString("dialog.newtileset.import.error.message");
    private static final String IMG_LOAD_ERROR = "图片加载错误";//Resources.getString("dialog.newtileset.imgload.error.message");
    private static final String COLOR_CHOOSE_ERROR_TITLE = "选择颜色错误";//Resources.getString("dialog.newtileset.colorchoose.error.title");
    private static final String PROPERTIES_TITLE = "默认属性";//Resources.getString("dialog.properties.default.title");
    private static final String PROPERTIES_BUTTON = "属性";//Resources.getString("dialog.newtileset.button.properties");
    /* -- */
