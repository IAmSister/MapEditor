...
/**
 * @version $Id: UndoHandler.java,v 1.1 2007/10/17 07:56:37 gulei Exp $
 */
public class UndoHandler extends UndoManager
{
    ...
    private class UndoAction extends AbstractAction {
        public UndoAction() {
            ...
            putValue(SHORT_DESCRIPTION, "³·Ïú");//"Undo one action");
    ...
    private class RedoAction extends AbstractAction {
        public RedoAction() {
            ...
            putValue(SHORT_DESCRIPTION, "ÖØ×ö");//Redo one action");
