 ...
 *
 * @version $Id: SaveAsAction.java,v 1.1 2007/10/17 07:56:37 gulei Exp $
 */
public class SaveAsAction extends AbstractAction
{
    ...
    private static final String ACTION_NAME = "另存为...";//Resources.getString("action.map.saveas.name");
    private static final String ACTION_TOOLTIP = "将地图另存为";//Resources.getString("action.map.saveas.tooltip");
    private static final String UNKNOWN_TYPE_MESSAGE = "未知文件类型";//Resources.getString("dialog.saveas.unknown-type.message");
    private static final String CONFIRM_MISMATCH = "文件扩展名与插件不匹配，您希望继续吗？";//Resources.getString("dialog.saveas.confirm.mismatch");
    private static final String CONFIRM_MISMATCH_TITLE = "强行保存？";//Resources.getString("dialog.saveas.confirm.mismatch.title");
    private static final String FILE_EXISTS_MESSAGE = "文件已经存在，您希望覆盖吗？";//Resources.getString("general.file.exists.message");
    private static final String FILE_EXISTS_TITLE = "覆盖文件？";//Resources.getString("general.file.exists.title");
    private static final String SAVEAS_ERROR_MESSAGE = "保存过程中发生错误";//Resources.getString("dialog.saveas.error.message");
    private static final String SAVEAS_ERROR_TITLE = "保存地图错误";//Resources.getString("dialog.saveas.error.title");
